            ...
            <div className="max-w-md w-full bg-white rounded-2xl border border-gray-100 shadow-sm p-8 space-y-6">
                ...
                {step === 1 ? (
                    <form onSubmit={submitCredentials} className="space-y-4">
                        ...
                        <button className="w-full bg-blue-600 text-white py-3 rounded-lg font-semibold hover:bg-blue-700">Continue to OTP</button>
                    </form>
                ) : (
                    <form onSubmit={submitOtp} className="space-y-4">
                        ...
                        <button className="w-full bg-blue-600 text-white py-3 rounded-lg font-semibold hover:bg-blue-700">Verify and Sign In</button>
                    </form>
                )}
